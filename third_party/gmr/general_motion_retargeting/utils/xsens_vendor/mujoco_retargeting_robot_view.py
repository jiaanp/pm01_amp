...
if __name__ == "__main__":
    ...
    parser.add_argument("--retargeting_data", required=True, help="Retargeted motion pickle path.")
    ...
    d = mujoco_displayanimanim(args.robot_xml, args.retargeting_data)
    d.save_as_csv(args.output_csv)
    d.animate_bvh()
